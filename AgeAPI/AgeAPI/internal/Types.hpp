...
namespace AgeAPI
{
    ...
    const std::string_view GetItemGroupString(ItemGroup group)
    {
   ...
   /*
     {
                    name: "BlockBounds",
                    type: "alias",
                    doc: "Defines the collision bounds of the block.",
                    value: {
                        type: "Vec3",
                        format: "array",
                        generics: [
                            { type: "range_inclusive", generics: [-8.0, 8.0] },
                            { type: "range_inclusive", generics: [0.0, 16.0] },
                            { type: "range_inclusive", generics: [-8.0, 8.0] }
                        ]
                    }
                },  */
