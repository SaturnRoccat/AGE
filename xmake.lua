...
add_requires("rapidjson", "angelscript", "uuid_v4", "libpng", "spdlog", "simde", "zlib")
...
target("AgeAPI")
    ...
    add_packages("rapidjson", "angelscript", "uuid_v4", "libpng", "spdlog", "AgeSharedUtils", "zlib", {public = true})
    set_symbols("debug")
...
target("AgeData")
    set_symbols("debug")
    set_kind("static")
    add_files("AgeData/**.cpp")
    add_includedirs("AgeData/", {public = true})
    add_headerfiles("AgeData/**.hpp")
    add_deps("AgeAPI", "AgeSharedUtils")
    add_packages("rapidjson")