...
add_requires("rapidjson", "angelscript", "uuid_v4", "libpng", "spdlog", "simde", "zlib", "abseil")
...
target("AgeAPI")
    ...
    add_includedirs("AgeAPI/AgeAPI/internal/Addon/AgeData", {public = true})
    add_headerfiles("AgeAPI/**.hpp")
    add_packages("rapidjson", "angelscript", "uuid_v4", "libpng", "spdlog", "AgeSharedUtils", "zlib", "abseil", {public = true})
    set_symbols("debug")
